...
const OcttoppusFooter = () => {
  ...
  return (
    <footer
      ...
      style={{ backgroundColor: 'var(--secondary-dark-bg)' }}
    >
      <LazyLoad offset={400} height={400}>
        <video autoPlay loop muted playsInline>
          <source
            src={backendUrl + 'videos/footer-wave.mp4'}
            type="video/mp4"
          />
      ...
      <div className="footer-content">
        <div className="footer-left">
          <div className="footer-logo-container">
            <OcttoppusLogo navigate={Navigate} isScrolledUp="true" />
          </div>
          <div className="footer-menu">
            {menuItemsWithLinks.map((menuItem, index) => (
              <a
                key={index}
                href={menuItem.mainMenuLink}
        ...
        <div className="footer-right">
          ...
          <div className="footer-copyright">
            <p>© copyright {currentYear} Octtoppus. All rights reserved. </p>
          </div>
        </div>
      </div>
    </footer>
