  ...
  ReactGA.send({
    ...
    return (
            <div className="enterprise-page-body">
              ...
              <meta name="twitter:title" content="Our Expertise | Octtoppus - Best Business Consultancy" />
              <meta name="twitter:description" content="Octtoppus demonstrates a strategic focus on innovation, which is evident in its commitment to exploring emerging technologies to offer a wide range of technology services, covering areas such as web design and development, Software Development, E-commerce Solutions, Digital Marketing, Cloud Solutions, and Business Consultancy." />
              <meta name="twitter:image" content="https://www.octtoppus.com/images/logos/octtoppus.png" />

              </Helmet>
                <div className="HeroC-container" style={{backgroundImage: `url(${enterpriseHero_bg_image})`}}>
                    <div className="hero-heading">
                        <HeroText color="white">Follow the Octtoppus Way!</HeroText>
                    </div>
                    <ScrollReveal delay={600}>
                        <p>We invite you to join us on this journey of growth and discovery. Whether you're a startup with a bold vision or an established enterprise seeking transformation, Octtoppus is here to take you by the hand and navigate the path to success. Embrace the power of eightfold expertise, and let's unlock the boundless potential that lies within your business.</p>
                    </ScrollReveal>
                </div>
                <OurExpertise />
